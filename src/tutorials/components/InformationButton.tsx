...
const InformationButton = ({ name, description, route }: Props) => {
  ...
  return (
    <button
      ...
      className="group flex flex-col text-left hover:bg-[#7A00E6] bg-[#FFFFFF] rounded-[20px] h-48 pl-2.5 pt-3 hover:text-[#ffffff] transition-transform duration-300 ease-in-out transform hover:-translate-y-1"
    >
