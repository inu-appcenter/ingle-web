  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-col gap-5 mx-4 my-5 text-[#383737] leading-[140%]">
        ...
        <h3>
          In Korea, many people believe it’s better to visit a hospital and get treatment
          quickly, even for minor symptoms. This means you can easily access medical
          services here. Don’t suffer alone!
          <br />
          <br />
        ...
        {hospitals.map((item, index) => (
          <div key={index} className="mb-2">
            <div className="flex flex-row items-center justify-between h-[60px] bg-[#F4F2F6] px-4 py-[10px]">
            ...
            <div>
              <ul>
                {item.name.map((hospital, idx) => (
                  <li className="flex flex-row items-center mt-5 pl-4 ">
                    {hospital}
